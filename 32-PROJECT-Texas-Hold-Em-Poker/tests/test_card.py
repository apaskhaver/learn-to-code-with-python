import unittest
# import Card class to test from poker directory
...
class TestCard(unittest.TestCase):
    ...
    def test_card_only_allows_for_valid_rank(self):
        # error you expect to raise
        with self.assertRaises(ValueError):
            # operation you expect to raise the error
    ...
    def test_can_create_standard_52_cards(self):
        ...
        # check we have 52 obj in list
        self.assertEqual(len(cards), 52)

        # check first and last objs are Cards
        # to ensure we have a list of Cards,
        # not ints, strs, etc.
        self.assertEqual(
            cards[0],
    ...
    def test_card_can_sort_itself_with_another_one(self):
        ...
        self.assertEqual(
            ...
            # above is optional error message
        )
